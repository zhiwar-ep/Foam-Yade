	...
	def process_block(self, block):
		...
		for token, data in block:
			if token == COMMENT:
				...
				found_input = True
				(out_data, input_lines, output, is_doctest, decorator, image_file,
...
class IPythonDirective(Directive):
	...
	def get_config_options(self):
		...
		return (savefig_dir, source_dir, rgxin, rgxout, promptin, promptout, mplbackend, exec_lines, hold_count)
