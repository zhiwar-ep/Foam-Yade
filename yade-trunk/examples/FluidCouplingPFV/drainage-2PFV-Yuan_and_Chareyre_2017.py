...
triax = TriaxialStressController(internalCompaction=True, goal1=confiningS, goal2=confiningS, goal3=confiningS, max_vel=10, label="triax")
...
O.engines = [
        ...
        GlobalStiffnessTimeStepper(active=1, timeStepUpdateInterval=100, timestepSafetyCoefficient=0.8), triax, newton
]
...
ei1 = -triax.strain[1]
ei2 = -triax.strain[2]
si0 = -triax.stress(0)[0]
si1 = -triax.stress(2)[1]
...
def history():
	plot.addData(
	        e11=-triax.strain[0] - ei0,
	        e22=-triax.strain[1] - ei1,
