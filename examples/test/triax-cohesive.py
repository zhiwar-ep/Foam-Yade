        ...
        InteractionLoop(
                ...
                [
                        ...
                        Law2_ScGeom6D_CohFrictPhys_CohesionMoment(
                                ...
                                False,  #if we want "rolling" friction even if the contact is not cohesive (or cohesion is broken), we will have to turn this true somewhere
                                label='cohesiveLaw'
                        )
                ]
        ),
